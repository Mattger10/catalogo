...
import moon from "../../../assets/Space/destination/image-moon.webp";
...
const Moon: FunctionComponent<MoonProps> = () => {
  return (
    <CustomFont>
      <div>
        <Img src={home} alt="" />
        ...
        <WrapperP>
        <P>
        Vea nuestro planeta como nunca antes lo había visto. Un viaje relajante, perfecto para ayudar a
  recuperar la perspectiva y volver renovado. Mientras estás allí, toma algo de historia
  visitando los sitios de aterrizaje de Luna 2 y Apolo 11.
        </P>
        <P2>DISTANCIA APROX.</P2>
        <P3>TIEMPO DE VIAJE ESTIMADO.</P3>
        <Km>384,400 km</Km>
        <Months>3 DÍAS</Months>
        </WrapperP>
        <Linea2 />
      </div>
    </CustomFont>
